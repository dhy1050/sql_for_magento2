SELECT 
    ...
    DATE_FORMAT(so.created_at,'%M') as order_month,
...
where sc.created_at >= '2016-06-01'
and so.increment_id like "2%"
and soas.region like '%New York%'
ORDER BY refund_id, order_number INTO OUTFILE "/var/lib/mysql-files/DM-refund_detail_New-York.csv"
